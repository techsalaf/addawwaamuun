        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              <a href="{{ route('admin.blog_management.create_blog', ['language' => $language->code]) }}" class="btn btn-primary btn-sm float-right"><i class="fas fa-plus"></i> {{ __('Add Blog') }}</a>
                    ...
                    <tbody>
                      @foreach ($blogs as $blog)
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm mr-1" href="{{ route('admin.blog_management.edit_blog', ['id' => $blog->id, 'language' => $language->code]) }}">
