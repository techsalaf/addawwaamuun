...
@section('content')
                    ...
                    <tbody>
                      @foreach ($coupons as $coupon)
                        ...
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm mr-1 editBtn" href="#" data-toggle="modal" data-target="#editModal" data-id="{{ $coupon->id }}" data-name="{{ $coupon->name }}" data-code="{{ $coupon->code }}" data-type="{{ $coupon->type }}" data-courses="{{ $coupon->courses }}" data-value="{{ $coupon->value }}" data-start_date="{{ date_format($date1, 'm/d/Y') }}" data-end_date="{{ date_format($date2, 'm/d/Y') }}">
                            ...
                            <form class="deleteForm d-inline-block" action="{{ route('admin.course_management.delete_coupon', ['id' => $coupon->id]) }}" method="post">
  ...
  {{-- create modal --}}
  @include('backend.curriculum.coupon.create')

  {{-- edit modal --}}
  @include('backend.curriculum.coupon.edit')
@endsection
