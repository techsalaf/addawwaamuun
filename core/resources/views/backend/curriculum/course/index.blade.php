        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              <a href="{{ route('admin.course_management.create_course', ['language' => $language->code]) }}" class="btn btn-primary btn-sm float-right"><i class="fas fa-plus"></i> {{ __('Add Course') }}</a>
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a href="{{ route('admin.course_management.edit_course', ['id' => $course->id, 'language' => $language->code]) }}" class="dropdown-item">
                                  {{ __('Information') }}
                                </a>

                                <a href="{{ route('admin.course_management.course.modules', ['id' => $course->id, 'language' => $language->code]) }}" class="dropdown-item">
                                  {{ __('Curriculum') }}
                                </a>

                                <a href="{{ route('admin.course_management.course.faqs', ['id' => $course->id, 'language' => $defaultLang->code]) }}" class="dropdown-item">
                                  {{ __('FAQs') }}
                                </a>
                                ...
                                <a href="{{ route('admin.course_management.course.certificate_settings', ['id' => $course->id]) }}" class="dropdown-item">
                                  {{ __('Certificate Settings') }}
                                </a>
                                
                                <a target="_blank" href="{{ url('/user/course-curriculum/' . $course->id . '?lesson_id=' . $course->lesson_id) }}" class="dropdown-item">
                                  {{ __('Preview') }}
                                </a>
