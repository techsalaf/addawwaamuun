      ...
      <div class="card">
        <div class="card-header p-1">
            <div class="row">
              ...
              <div class="col-lg-2">
                <form action="{{route('admin.course_enrolments.export')}}" class="form-inline justify-content-end">
                    <div class="form-group">
                    ...
                    <tbody>
                      @foreach ($enrolments as $key => $enrolment)
                        <tr>
                          ...
                          @endphp
                          <td><a href="{{url('/course/' . $slug)}}" target="_blank">{{strlen($title) > 35 ? mb_substr($title, 0, 35, 'utf-8') . '...' : $title}}</a></td>
