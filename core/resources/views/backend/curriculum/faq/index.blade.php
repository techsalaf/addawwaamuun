...
@section('content')
        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
              ...
              <button class="btn btn-danger float-right btn-sm mr-2 d-none bulk-delete" data-href="{{ route('admin.course_management.course.bulk_delete_faq') }}">
                      ...
                      @foreach ($faqs as $faq)
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block" action="{{ route('admin.course_management.course.delete_faq', ['id' => $faq->id]) }}" method="post">
  ...
  {{-- create modal --}}
  @include('backend.curriculum.faq.create')

  {{-- edit modal --}}
  @include('backend.curriculum.faq.edit')
@endsection
