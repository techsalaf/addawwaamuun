        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              <form id="heroForm" action="{{ route('admin.home_page.update_hero_section') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="language" value="{{ request()->input('language', isset($language) ? $language->code : '') }}">
                <div class="form-group">
                  <label for="">{{ __('Background Image') . '*' }}</label>
                  <br>
                  <div class="thumb-preview">
                    @if (!empty($data->background_image))
                      <img src="{{ asset('assets/img/hero-section/' . $data->background_image) }}" alt="background image" class="uploaded-background-img">
                    @else
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control ltr" name="first_button_url" value="{{ empty($data->first_button_url) ? '' : $data->first_button_url }}" placeholder="Enter First Button URL">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control ltr" name="second_button_url" value="{{ empty($data->second_button_url) ? '' : $data->second_button_url }}" placeholder="Enter Second Button URL">
                      </div>
                    </div>
                  </div>
                @endif
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control ltr" name="video_url" value="{{ empty($data->video_url) ? '' : $data->video_url }}" placeholder="Enter Video URL">
                      </div>
                    </div>
                  </div>
                @endif
                ...
                @if ($themeInfo->theme_version == 3)
                  <div class="form-group">
                    ...
                    <div class="thumb-preview">
                      @if (!empty($data->image))
                        <img src="{{ asset('assets/img/hero-section/' . $data->image) }}" alt="image" class="uploaded-img">
                      @else
