    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              <form id="languageKeywordForm" action="{{ route('admin.language_management.update_keyword', ['id' => $language->id]) }}" method="post">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-4 mt-2">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input class="form-control form-control-lg" type="text" name="keyValues[{{ $keyword }}]" value="{{ $value }}">
                        </div>
                      </div>
                    </div>
                  @endforeach
