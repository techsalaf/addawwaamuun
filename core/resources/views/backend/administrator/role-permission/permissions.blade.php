...
@section('content')
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <form action="{{ route('admin.admin_management.update_role', ['id' => $role->id]) }}" method="post">
          @csrf
              ...
              <div class="col-lg-10">
                <div class="form-group">
                  <div class="selectgroup selectgroup-pills">
                    ...
                    <label class="selectgroup-item">
                      <input type="checkbox" class="selectgroup-input" name="permissions[]" value="Instructors" @if (is_array($rolePermissions) && in_array('Instructors', $rolePermissions)) checked @endif>
                      <span class="selectgroup-button">{{ __('Instructors') }}</span>
                    </label>

                    <label class="selectgroup-item">
                      <input type="checkbox" class="selectgroup-input" name="permissions[]" value="Course Management" @if (is_array($rolePermissions) && in_array('Course Management', $rolePermissions)) checked @endif>
                      <span class="selectgroup-button">{{ __('Course Management') }}</span>
                    </label>

                    <label class="selectgroup-item">
                      <input type="checkbox" class="selectgroup-input" name="permissions[]" value="Course Enrolments" @if (is_array($rolePermissions) && in_array('Course Enrolments', $rolePermissions)) checked @endif>
                      <span class="selectgroup-button">{{ __('Course Enrolments') }}</span>
                    </label>
