              ...
              <div class="col-lg-6 offset-lg-3">
                <div class="form-group">
                  ...
                  @if ($errors->has('primary_color'))
                    <p class="mb-0 text-danger">{{ $errors->first('primary_color') }}</p>
                  @endif
                </div>
                ...
                <div class="form-group">
                  ...
                  @if ($errors->has('secondary_color'))
                    <p class="mb-0 text-danger">{{ $errors->first('secondary_color') }}</p>
                  @endif
                </div>
                ...
                <div class="form-group">
                  ...
                  @if ($errors->has('breadcrumb_overlay_color'))
                    <p class="mb-0 text-danger">{{ $errors->first('breadcrumb_overlay_color') }}</p>
                  @endif
                </div>
                ...
                <div class="form-group">
                  ...
                  @if ($errors->has('breadcrumb_overlay_opacity'))
                    <p class="mb-0 text-danger">{{ $errors->first('breadcrumb_overlay_opacity') }}</p>
                  @endif
