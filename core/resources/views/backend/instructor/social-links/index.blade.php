...
@section('content')
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <form id="ajaxForm" action="{{ route('admin.instructor.store_social_link', ['id' => $instructor->id]) }}" method="post">
          @csrf
                    ...
                    <tbody>
                      @foreach ($socialLinks as $socialLink)
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm mr-1" href="{{ route('admin.instructor.edit_social_link', ['instructor_id' => $socialLink->instructor_id, 'id' => $socialLink->id]) }}">
                              <span class="btn-label">
                            ...
                            <form class="d-inline-block deleteForm" action="{{ route('admin.instructor.delete_social_link', ['id' => $socialLink->id]) }}" method="post">
