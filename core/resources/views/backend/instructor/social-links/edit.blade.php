...
@section('content')
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <form id="ajaxEditForm" action="{{ route('admin.instructor.update_social_link', ['id' => $socialLink->id]) }}" method="post">
          ...
          <div class="card-header">
            ...
            <a class="btn btn-info btn-sm float-right d-inline-block" href="{{ route('admin.instructor.social_links', ['id' => $instructor->id]) }}">
            ...
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                ...
                <div class="form-group">
                  ...
                  <input type="url" class="form-control" name="url" value="{{ $socialLink->url }}" placeholder="Enter URL of Social Media Account">
