    ...
    <div class="login-container">
      <div class="auth-card">
        ...
        <div class="auth-header text-center">
          ...
          <p>{{ __('Enter your credentials to manage your platform') }}</p>
        </div>
        ...
        <form action="{{ route('admin.login_submit') }}" method="POST">
          ...
          <div class="form_group">
            ...
            <div class="input-with-icon">
              <input type="text" name="username" class="form_control" placeholder="{{ __('Enter Username') }}" required>
              <i class="fal fa-user"></i>
            </div>
            @if ($errors->has('username'))
              <p class="text-danger mt-1 small">{{ $errors->first('username') }}</p>
            @endif
          </div>
          ...
          <div class="form_group">
            ...
            <div class="input-with-icon">
              <input type="password" name="password" class="form_control" placeholder="{{ __('Enter Password') }}" required>
              <i class="fal fa-lock"></i>
            </div>
            @if ($errors->has('password'))
              <p class="text-danger mt-1 small">{{ $errors->first('password') }}</p>
            @endif
          </div>
