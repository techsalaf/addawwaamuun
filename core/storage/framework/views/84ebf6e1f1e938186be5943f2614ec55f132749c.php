...
<?php $__env->startSection('content'); ?>
  <div class="page-header">
    <h4 class="page-title"><?php echo e(__('Theme V4 - Hero Section')); ?></h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#"><?php echo e(__('Theme V4 - Hero Section')); ?></a>
      </li>
    </ul>
  </div>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="card-title"><?php echo e(__('Update Hero Section Settings')); ?></div>
        </div>

        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              <form id="heroForm" action="<?php echo e(route('admin.theme_v4.update_hero_settings')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>

                <div class="form-group">
                  <label><?php echo e(__('Title') . '*'); ?></label>
                  <input type="text" class="form-control" name="title" value="<?php echo e($data->title ?? ''); ?>" placeholder="Enter hero title" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="subtitle" value="<?php echo e($data->subtitle ?? ''); ?>" placeholder="Enter hero subtitle" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="description" rows="4" placeholder="Enter description" required><?php echo e($data->description ?? ''); ?></textarea>
                ...
                <div class="form-group">
                  ...
                  <div class="thumb-preview">
                    <?php if(!empty($data->background_image)): ?>
                      <img src="<?php echo e(asset('assets/img/hero-section/' . $data->background_image)); ?>" alt="background" class="uploaded-bg-img">
                    <?php else: ?>
                      <img src="<?php echo e(asset('assets/img/noimage.jpg')); ?>" alt="..." class="uploaded-bg-img">
                    <?php endif; ?>
                  </div>
                  <div class="mt-3">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="button_1_text" value="<?php echo e($data->button_1_text ?? ''); ?>" placeholder="e.g., Get Started">
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\addawwaamuun\core\resources\views/backend/home-page/theme-v4/hero-settings.blade.php ENDPATH**/ ?>