    ...
    <div class="login-container">
      <div class="auth-card">
        ...
        <div class="auth-header text-center">
          ...
          <p><?php echo e(__('Enter your registered email and we will send you a new password')); ?></p>
        </div>

        <form action="<?php echo e(route('admin.mail_for_forget_password')); ?>" method="POST">
          <?php echo csrf_field(); ?>
          <div class="form_group">
            <label><?php echo e(__('Email Address')); ?></label>
            <div class="input-with-icon">
              <input type="email" name="email" class="form_control" placeholder="<?php echo e(__('Enter Your Email')); ?>" value="<?php echo e(old('email')); ?>" required>
              <i class="fal fa-envelope"></i>
            </div>
            <?php if($errors->has('email')): ?>
              <p class="text-danger mt-1 small"><?php echo e($errors->first('email')); ?></p>
            <?php endif; ?>
          </div>

          <button type="submit" class="btn-login">
            <span><?php echo e(__('Send New Password')); ?></span>
            <i class="fal fa-paper-plane"></i>
          </button>
        </form>

        <a class="back-link" href="<?php echo e(route('admin.login')); ?>">
          <i class="fal fa-arrow-left mr-1"></i> <?php echo e(__('Back to Login')); ?>
...
<?php /**PATH C:\xampp\htdocs\addawwaamuun\core\resources\views/backend/forget-password.blade.php ENDPATH**/ ?>