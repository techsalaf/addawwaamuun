        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              <form id="newsletterForm" action="<?php echo e(route('admin.home_page.update_newsletter_section', ['language' => request()->input('language')])); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="thumb-preview">
                      <?php if(!empty($data->background_image)): ?>
                        <img src="<?php echo e(asset('assets/img/newsletter-section/' . $data->background_image)); ?>" alt="background image" class="uploaded-background-img">
                      <?php else: ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="thumb-preview">
                      <?php if(!empty($data->image)): ?>
                        <img src="<?php echo e(asset('assets/img/newsletter-section/' . $data->image)); ?>" alt="image" class="uploaded-img">
                      <?php else: ?>
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\addawwaamuun\core\resources\views/backend/home-page/newsletter-section.blade.php ENDPATH**/ ?>