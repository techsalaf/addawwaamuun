  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxEditForm" class="modal-form" action="<?php echo e(route('admin.payment_gateways.update_offline_gateway')); ?>" method="POST">
          <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\addawwaamuun\core\resources\views/backend/payment-gateways/offline-gateways/edit.blade.php ENDPATH**/ ?>