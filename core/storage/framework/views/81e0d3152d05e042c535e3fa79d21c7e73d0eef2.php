...
<?php $__env->startSection('content'); ?>
  <div class="page-header">
    <h4 class="page-title"><?php echo e(__('Action Section')); ?></h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#"><?php echo e(__('Action Section')); ?></a>
      </li>
    </ul>
  </div>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-10">
              <div class="card-title"><?php echo e(__('Update Action Section')); ?></div>
            </div>
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              <form id="actionForm" action="<?php echo e(route('admin.home_page.update_action_section', ['language' => request()->input('language')])); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="form-group">
                  ...
                  <div class="thumb-preview">
                    <?php if(!empty($data->background_image)): ?>
                      <img src="<?php echo e(asset('assets/img/action-section/' . $data->background_image)); ?>" alt="background image" class="uploaded-background-img">
                    <?php else: ?>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="url" class="form-control ltr" name="first_button_url" value="<?php echo e(empty($data->first_button_url) ? '' : $data->first_button_url); ?>" placeholder="Enter First Button URL">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="url" class="form-control ltr" name="second_button_url" value="<?php echo e(empty($data->second_button_url) ? '' : $data->second_button_url); ?>" placeholder="Enter Second Button URL">
                    </div>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="thumb-preview">
                      <?php if(!empty($data->image)): ?>
                        <img src="<?php echo e(asset('assets/img/action-section/' . $data->image)); ?>" alt="image" class="uploaded-img">
                      <?php else: ?>
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\addawwaamuun\core\resources\views/backend/home-page/action-section.blade.php ENDPATH**/ ?>