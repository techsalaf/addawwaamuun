        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              <form id="ajaxEditForm" action="<?php echo e(route('admin.user_management.user.update_password', ['id' => $userInfo->id])); ?>" method="post">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\addawwaamuun\core\resources\views/backend/end-user/user/change-password.blade.php ENDPATH**/ ?>