  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form create" action="<?php echo e(route('admin.home_page.store_feature', ['language' => request()->input('language')])); ?>" method="post">
          <?php echo csrf_field(); ?>
          ...
          <div class="form-group">
            ...
            <p id="err_background_color" class="mt-1 mb-0 text-danger em"></p>
          </div>
...
<?php /**PATH C:\xampp\htdocs\addawwaamuun\core\resources\views/backend/home-page/feature-section/create.blade.php ENDPATH**/ ?>