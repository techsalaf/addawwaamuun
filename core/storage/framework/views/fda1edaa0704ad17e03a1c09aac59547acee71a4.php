  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form create" action="<?php echo e(route('admin.blog_management.store_category')); ?>" method="post">
          <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\addawwaamuun\core\resources\views/backend/journal/category/create.blade.php ENDPATH**/ ?>