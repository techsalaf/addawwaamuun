...
<?php $__env->startSection('content'); ?>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <form action="<?php echo e(route('admin.user_management.push_notification.send_notification')); ?>" method="post">
          <?php echo csrf_field(); ?>
            ...
            <div class="row">
              <div class="col-lg-8 offset-lg-2">
                ...
                <div class="form-group">
                  ...
                  <p class="mb-0">
                    <a href="//www.attheminute.com/vapid-key-generator/" target="_blank" class="redirect-link"><?php echo e(__('Click Here')); ?></a> <?php echo e(__('to generate the VAPID Public Key & the VAPID Private Key') . '.'); ?>
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\addawwaamuun\core\resources\views/backend/end-user/push-notification/write-notification.blade.php ENDPATH**/ ?>