  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"><?php echo e(__('Add Social Media')); ?></h5>
      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form" action="<?php echo e(route('admin.basic_settings.store_social_media')); ?>" method="post">
          <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\addawwaamuun\core\resources\views/backend/basic-settings/social-media/create.blade.php ENDPATH**/ ?>