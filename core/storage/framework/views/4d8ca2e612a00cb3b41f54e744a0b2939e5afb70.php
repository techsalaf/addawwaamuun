                    ...
                    <tbody>
                      <?php $__currentLoopData = $medias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm mr-1 editBtn" href="#" data-toggle="modal" data-target="#editModal" data-id="<?php echo e($media->id); ?>" data-icon="<?php echo e($media->icon); ?>" data-url="<?php echo e($media->url); ?>" data-serial_number="<?php echo e($media->serial_number); ?>">
                            ...
                            <form class="deleteForm d-inline-block" action="<?php echo e(route('admin.basic_settings.delete_social_media', ['id' => $media->id])); ?>" method="post">
...
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\addawwaamuun\core\resources\views/backend/basic-settings/social-media/index.blade.php ENDPATH**/ ?>