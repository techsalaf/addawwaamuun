  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form" action="<?php echo e(route('admin.admin_management.store_role')); ?>" method="post">
          <?php echo csrf_field(); ?>
          <div class="row">
            <div class="col">
...
<?php /**PATH C:\xampp\htdocs\addawwaamuun\core\resources\views/backend/administrator/role-permission/create.blade.php ENDPATH**/ ?>