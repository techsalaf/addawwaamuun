...
class BlogController extends Controller
{
  ...
  public function details($slug)
  {
    ...
    $queryResult['details'] = Blog::join('blog_informations', 'blogs.id', '=', 'blog_informations.blog_id')
      ...
      ->select('blogs.image', 'blogs.created_at', 'blog_informations.title', 'blog_informations.slug', 'blog_informations.content', 'blog_informations.meta_keywords', 'blog_informations.meta_description', 'blog_categories.name as categoryName')
      ->firstOrFail();
